...
def create_arg_parser():
    ...
    parser.add_argument("-lp", "--label_present", action="store_true",
                        help="Label is present (tab-separated), add again and do not tokenize/lowercase")
...
def tokenize_and_lowercase(in_file, no_tokenize, no_lower, lang, label_present):
    ...
    for line in open(in_file, 'r'):
        ...
        if label_present:
            if not label:
                raise ValueErorr("Should always find label when specifiying -lp of --label_present")
            line += "\t" + label
...
if __name__ == '__main__':
    ...
    lines = tokenize_and_lowercase(args.input_file, args.no_tokenize, args.no_lower, args.lang, args.label_present)
